...
data = pd.read_csv(os.path.join(data_directory, 'correlation_filtered/CorrelationFiltered0.9.tsv'), sep = '\t', index_col = 0)
...
candidate_features = [p for p in data.columns if 'GEX' in p] + features['cell_freq'] + features['cytokine'] + features['demographic']
...
output_path = '/mnt/bioadhoc/Users/erichard/CMIPB_Autogluon_Uncorrelated'
cv_results = []
