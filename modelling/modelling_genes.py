...
def load_data(path = '/content/drive/MyDrive/CMIPB_Files/IntegratedData.tsv', target = 'Day14_IgG_Titre', transform = True, keep = False):
...
results_directory = f'/mnt/bioadhoc/Users/erichard/cell_crushers/results_justgenes'
